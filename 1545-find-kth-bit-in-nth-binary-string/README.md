...
<p>Return <em>the</em> <code>k<sup style="">th</sup></code> <em>bit</em> <em>in</em> <code>S<sub>n</sub></code>. It is guaranteed that <code>k</code> is valid for the given <code>n</code>.</p>
...
The 1<sup style="">st</sup> bit is "0".
</pre>
...
The 11<sup style="">th</sup> bit is "1".
</pre>
...
<ul>
	...
	<li><code>1 &lt;= k &lt;= 2<sup style="">n</sup> - 1</code></li>
</ul>
</div>
# Find first set bit
## Easy
<div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an integer an <strong>N.</strong> The task is to return the position of <strong>first set bit found from the right side</strong> in the binary representation of the number.<br>

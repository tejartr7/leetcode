<h2><a href="https://leetcode.com/problems/count-asterisks/">2315. Count Asterisks</a></h2><h3>Easy</h3><hr><div data-read-aloud-multi-block="true"><p>You are given a string <code>s</code>, where every <strong>two</strong> consecutive vertical bars <code>'|'</code> are grouped into a <strong>pair</strong>. In other words, the 1<sup style="">st</sup> and 2<sup style="">nd</sup> <code>'|'</code> make a pair, the 3<sup style="">rd</sup> and 4<sup style="">th</sup> <code>'|'</code> make a pair, and so forth.</p>
